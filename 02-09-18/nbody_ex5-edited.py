...
def initialize(n, seed, v0):
    ...
    if n == 2:
        ...
        ve = math.sqrt((mass[0] + mass[1])/1.0)
...
def main(N, seed, eps, dt, t_end, v0):
    ...
    while t < (t_end-0.5*dt):
        ...
        earth = orbital_elements(mass[0], mass[1], pos[0], pos[1], vel[0], vel[1], eps2)
        jupiter = orbital_elements(m1, m2, x1, x2, v1, v2, eps2)
        Es.append(E-E0)
        ts.append(t)
        saxs.append(ax)
        es.append(e)
...
def new_option_parser():
    ...
    result.add_option("-rj",
                      dest="rj", type="float", default ="2.5",
                      help="initial 2-body v [%default]")
    result.add_option("-mj",
